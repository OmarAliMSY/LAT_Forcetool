...
class Forcetool:
    ...
    def __init__(self,m,c=113 ,h=482,v=1563,push=True,west=True) -> None:
        self.c = c                                  
        self.h = h                                  
        self.v = v                                  
    ...
    def latforce(self,theta):
        ...
        p =  1 if not self.push else -1
        k = -1 if not self.west else 1
    ...
    def get_torque_factor(self,force):
        """
        ...
        torque_factors = tf_push if self.push else tf_pull
